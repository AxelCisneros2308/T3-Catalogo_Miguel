 ...
 */
public class NuevaRopa extends javax.swing.JFrame {

    private Catalogo padre;
    /**
     * Creates new form NuevaRopa
     */
    public NuevaRopa() {
        initComponents();
    }
    
    public NuevaRopa(Catalogo padre) {
        initComponents();
        this.padre = padre;
    }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
     ...
     int precio = Integer.parseInt(precioTexto);
        ...
        Ropa ropa = new Ropa(nombre, codigo, precio);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NuevaRopa.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
